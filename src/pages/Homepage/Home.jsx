  ...
  return (
      ...
      <div className="flex-grow flex flex-col space-y-4">
        ...
        <div className="bg-gray-100 dark:bg-gray-700 p-6 rounded-lg">
          ...
          <p className="text-lg text-gray-800 dark:text-gray-300 mt-4">
            I am an active learner, recently taking courses at the Matsuo-Iwasawa Research lab to deepen my understanding of LLMs.
          </p>
          <p className="text-lg text-gray-800 dark:text-gray-300 mt-4">
    ...
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-5xl mx-auto">
      ...
      <p className="text-gray-600 dark:text-gray-400">
        I am currently a student at the Institute of Science Tokyo, where I am pursuing a degree in Computer Science. My academic journey has been focused on Artificial Intelligence, and I have been fortunate to learn from leading experts in the field. I am also an active member of the Matsuo-Iwasawa Research lab, where I am engaged in cutting-edge research on Large Language Models.
      </p>
    </div>

    {/* Third Block: Articles */}
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-5xl mx-auto">
      <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Articles</h3>
      <p className="text-gray-600 dark:text-gray-400">
    ...
    {/* Fourth Block: Works */}
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg max-w-5xl mx-auto">
      <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Works</h3>
      <p className="text-gray-600 dark:text-gray-400">
